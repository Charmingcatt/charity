    ...
    <el-card>
      ...
      <div class="main">
        <el-form :model="newForm" ref="ruleForm" label-width="80px" label-position="left" class="form">
          ...
          <el-form-item label="帖子地址" prop="address">
          ...
          <el-form-item label="类型" prop="type">
            <el-select v-model="newForm.type" placeholder="帖子类型">
              <el-option label="信息公开" :value="1"></el-option>
              <el-option label="慈善帖子" :value="2"></el-option>
        ...
        <mavon-editor ref="md" placeholder="请输入帖子内容..." :boxShadow="false"
...
<script>
  export default {
    ...
    methods: {
      ...
      async add() {
        ...
        if (res.status === 200 && res.data.success) {
          ...
          this.$router.push('/teamInfo?id=' + this.newForm.team_no)
    ...
    created() {
      this.newForm.team_no = this.$route.params.team_no
    }
  }
</script>
