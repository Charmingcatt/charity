  ...
  <div class="wrapper">
    <div class="wscn-http404-container">
      <div class="wscn-http404">
        ...
        <div class="bullshit">
          <div class="bullshit__oops">请检查路径！</div>
          <div class="bullshit__info">爱心公益网站
            <a style="color:#20a0ff" href="http://localhost:8080/">首页</a>
          </div>
          <div class="bullshit__headline">{{ message }}</div>
          <div class="bullshit__info">点击此处回首页</div>
          <a href="http://localhost:8080/" class="bullshit__return-home">回首页</a>
        </div>
      </div>
    </div>
  </div>
